...
import { Accordion, C, CATS, COUNTRY_CONFIG, DEFAULT_COUNTRY, DeadlineBanner, DocumentUpload, EscalationCard, FREE_LIMIT, FollowUpChat, Lantern as WaythroughIcon, MODEL, S, SANS, SERIF, VoiceInput, detectCountry, fileToBase64, getCountryConfig, getFollowUp, getGuidance, monthKey, urgencyColor, urgencyEmoji } from './lib.jsx';
  ...
  return (
    <div style={{ padding: "0 20px 140px" }}>
      ...
      <div style={{ background: C.surf, border: `1px solid ${C.border}`, borderRadius: 16, padding: "18px", marginBottom: 20 }}>
        ...
        {left === 0 ? (
          <button onClick={() => alert("Payment integration coming soon!\nWaythrough Pro — £6.99/month.")} style={{ width: "100%", padding: "13px 0", borderRadius: 10, background: C.accent, border: "none", cursor: "pointer", fontFamily: SANS, fontSize: 14, fontWeight: 700, color: "#1A0E00" }}>
