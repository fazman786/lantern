...
═══════════════════════════════════════════════════════ */
const CATS = [
  { id:"debt",       label:"Debt & Bills",       emoji:"💳", color:"#E8574A", hint:"e.g. I've received a final demand letter and I don't know what to do…" },
  { id:"legal",      label:"Legal Letters",       emoji:"⚖️", color:"#8B7EE8", hint:"e.g. I've been served a court claim form and I've never dealt with this before…" },
  { id:"contract",   label:"Contracts",           emoji:"📋", color:"#E9A84C", hint:"e.g. My landlord wants me to sign a new agreement with clauses I don't understand…" },
  { id:"tax",        label:"Tax & Revenue",       emoji:"🧾", color:"#3EBF8A", hint:"e.g. I received a tax investigation notice and I'm worried what happens next…" },
  { id:"benefits",   label:"Benefits & Housing",  emoji:"🏠", color:"#4BA3E8", hint:"e.g. My benefits have been stopped without explanation and I'm struggling to pay rent…" },
  { id:"employment", label:"Employment",          emoji:"💼", color:"#E87B4B", hint:"e.g. My employer is asking me to sign a settlement agreement after making me redundant…" },
];
